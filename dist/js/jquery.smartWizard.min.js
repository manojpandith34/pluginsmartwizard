...
!function (h, i, t) {
    ...
    var e = {
        ...
        anchorSettings: {
            ...
            enableAllAnchors: !1,
            markDoneStep: !0,
            markAllPreviousStepsAsDone: !0, removeDoneStepOnNavigateBack: !1, enableAnchorOnDoneStep: !0
        }, contentURL: null, contentCache: !0, ajaxSettings: {}, disabledSteps: [], errorSteps: [], hiddenSteps: [], theme: "default", transitionEffect: "none", transitionSpeed: "400"
    };
    function n(t, s) {
        this.options = h.extend(!0, {}, e, s), this.main = h(t),
            this.nav = this.main.children("ul"), this.steps = h("li > a",
                this.nav), this.container = this.main.children("div"),
            ...
            var e = this; return h(this.steps).on("click", function (t) { if (t.preventDefault(), !1 === e.options.anchorSettings.anchorClickable) return !0; var s = e.steps.index(this); if (!1 === e.options.anchorSettings.enableAnchorOnDoneStep && e.steps.eq(s).parent("li").hasClass("done")) return !0; s !== e.current_index && (!1 !== e.options.anchorSettings.enableAllAnchors && !1 !== e.options.anchorSettings.anchorClickable ? e._showStep(s) : e.steps.eq(s).parent("li").hasClass("done") && e._showStep(s)) }),
                h(".sw-btn-next", this.main).on("click", function (t) {
                    ...
                    if (e.current_index === 0) {
                        ...
                        if (orgname === '' || !orgname.trim().match(orgNameExp) || orgdescription.trim() === '' || !orgdescription.trim().match(orgdescriptionEXP) || !fileExp.exec(filepath)) {
                            console.log("inside")
                            t.preventDefault()
                        }
                        else {
